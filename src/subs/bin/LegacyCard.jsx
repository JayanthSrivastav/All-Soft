...
export default function BasicCard() {
  ...
  <Card
    sx={{
      minWidth: 250,
      borderRadius: '16px',
      backgroundColor: "#1e2327", // Darker background for better contrast
      color: "#03dac5",
      boxShadow: '0 4px 20px rgba(0, 0, 0, 0.5)', // Add some depth
    }}
  >
    <CardActionArea href='/postman'>
      <CardMedia
        sx={{ height: 180, borderRadius: '16px 16px 0 0' }} // Rounded top corners
        image="https://miro.medium.com/max/894/1*0jyROv8ksMb6tZtlf2ewVQ.png"
        title="Postman"
      />
      <CardContent>
